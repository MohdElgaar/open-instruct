...
from transformers import AutoModelForCausalLM, AutoModelForImageTextToText, PreTrainedModel, PreTrainedTokenizer, get_scheduler
...
class PolicyTrainerRayProcess(RayProcess):
    ...
    def from_pretrained(
        ...
        model_name_or_path = model_config.model_name_or_path
        model_cls = AutoModelForImageTextToText if "Qwen3.5" in model_name_or_path else AutoModelForCausalLM
        logger.info(
